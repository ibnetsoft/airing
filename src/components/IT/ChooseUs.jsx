    ...
    <section className="choose-us style-2 border-top bg-darkBlue brd-light section-padding" data-scroll-index="4">
      <div className="container">
        <div className="section-head mb-30 text-center">
          <h2 className="text-white ltspc-20 text-uppercase fs-1 lh-1 mb-70">Ai + RING</h2>
        </div>
        <div className="row align-items-center">
          ...
          <div className="col-lg-6">
            <div className="info">
              <p className="text-white text-uppercase mb-60">We create AI agency services in the trading<br />   field</p>
              <ul>
                {
